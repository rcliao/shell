...
install-skills: skills
	@for skill in web-search generate-image browser hello weather summarize shell-pm shell-tunnel shell-relay shell-schedule shell-remember shell-task project; do \
